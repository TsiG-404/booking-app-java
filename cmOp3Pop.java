...
public class cmOp3Pop extends JFrame {
    ...
    /**
     * <p>
     *this is the gui and code for the choice to see all the rooms in the client menu made with java swing
     *<br>
     * @param -
     * @return
     * @see -
     * @author tsig-404
     */
    public cmOp3Pop(String name, HashMap<String, String> aausers, HashMap<String, String> arentals,
